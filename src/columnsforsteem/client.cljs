      ...
      [ui/drawer {:open (:drawer-open @app-state)
       ...
       [ui/list
        ...
        [:a {:target "_blank"
         ...
         [ui/list-item
          [:b "Columns for Steem"]
          " is an Open Source client for the decentralized blockchain based
          social network Steem. The content you see in the application
          is generated by Steem users and is not hosted on this website."]]
        [:a {:target "_blank"
             :href "https://github.com/cryptowyrm/columnsforsteem/blob/master/LICENSE"
             :style {:text-decoration "none"}}
          [ui/list-item
           "This application is licensed under the MIT license, use it on your own
           risk, I disclaim any legal responsibility to the extent possible by
           applicable law."]]
        [ui/subheader "Contact"]
        [:a {:target "_blank"
             :href "https://github.com/cryptowyrm/columnsforsteem/labels/bug"
             :style {:text-decoration "none"}}
         [ui/list-item
          ...
          " Report an issue"]]
        [:a {:target "_blank"
             :href "https://github.com/cryptowyrm/columnsforsteem/labels/enhancement"
             :style {:text-decoration "none"}}
         [ui/list-item
          [:span {:style {:font-size 20}}
           "💡"]
